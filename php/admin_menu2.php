...
$result = $conn->query("SELECT * FROM menus2 ORDER BY week, day, id");
?>
...
.empty{background:white;border-radius:16px;padding:40px;text-align:center;box-shadow:0 8px 25px rgba(0,0,0,0.08);} footer{background:var(--primary);color:white;margin-top:40px;position:relative;} .footer::before{content:'';position:absolute;top:0;left:0;right:0;height:4px;background:linear-gradient(90deg,var(--accent),var(--primary-soft));} .footer-container{max-width:1180px;margin:0 auto;padding:40px 24px;display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:32px;} .footer-section h3,.footer-section h4{margin-bottom:16px;font-weight:600;color:white;} .footer-section p,.footer-section a{font-size:0.95rem;line-height:1.7;color:rgba(255,255,255,0.9);} .footer-section a{color:var(--accent);text-decoration:none;} .footer-bottom{text-align:center;padding:20px 24px;border-top:1px solid rgba(255,255,255,0.1);font-size:0.9rem;color:rgba(255,255,255,0.7);} @media(max-width:700px){.nav{grid-template-columns:1fr;gap:15px;}.nav-links{flex-wrap:wrap;justify-content:center;}.hero h1{font-size:32px;}.action-bar{flex-direction:column;align-items:flex-start;}.footer-container{grid-template-columns:1fr;}}
...
<div class="nav">
    ...
    <div class="nav-links">
        ...
        <a class="active" href="admin_menu2.php">Menú General</a>
    </div>
    <div class="nav-right"><a class="logout" href="logout.php">Tanca sessió</a></div>
</div>
<div class="hero"><h1>Admin Menú General</h1></div>
<div class="admin-container">
    <div class="action-bar">
        <h2>Gestió del menú general</h2>
...
<footer class="footer">
    <div class="footer-container">
        ...
        <div class="footer-section"><h4>Legal</h4><a href="cookies.php" target="_blank" rel="noopener noreferrer">Cookies</a><br><a href="legal.php" target="_blank" rel="noopener noreferrer">Avís legal</a><br><a href="privacy.php" target="_blank" rel="noopener noreferrer">Protecció de dades</a></div>
    </div>
