...
/* CATEGORY TITLE (NOVO, NÃO ALTERA ANIMAÇÕES) */
.category-title{
    grid-column: 1 / -1;
    font-size: 20px;
    font-weight: 700;
...
<div class="nav">
    <div class="logo"><a href="index.php"><img src="images/inspedr.jpg"></a></div>
    <div class="nav-links">
...
<div class="hero"><h1>Productes de menjador</h1></div>
